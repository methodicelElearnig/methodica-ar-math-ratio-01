'use strict';
/* ═══════════ methodica-math-ratio-01-03 — component 3 of 6 of methodica-math-ratio-01 ═══════════
...
var PART_NEXT = 'methodica-math-ratio-01-04';
var PART_PREV = 'methodica-math-ratio-01-02';

var XAPI_COMP_SLUG = 'methodica-math-ratio-01-03';
var XAPI_COMP_ID   = XAPI_ID_PREFIX + XAPI_COMP_SLUG + '/';
var XAPI_METADATA_FILE = '../metadata/methodica-math-ratio-01-03.json';
...
function mcqReset(q) {
  ...
  const chk = document.getElementById(q.id + '-check');
  if (chk) { setNavLabel(chk, 'هل صدقت؟'); chk.disabled = true; }
}
